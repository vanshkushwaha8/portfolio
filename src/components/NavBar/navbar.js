...
<div className="desktopMenu">
  ...
  <Link activeClass='active' to='intro' spy={true} smooth={true} offset={-100} duration={500} className="desktopMenuListItem"><span class="text">Home</span></Link>
</button>
<button class="Projects-Button">
  <span class="IconContainer">
    <svg
  ...
  <Link activeClass='active' to='skills' spy={true} smooth={true} offset={-50} duration={500} className="desktopMenuListItem"><span class="text">About</span></Link></button>
...
<button class="Projects-Button">
  ...
  <Link activeClass='active' to='works' spy={true} smooth={true} offset={-50} duration={500} className="desktopMenuListItem"><span class="text">Portfolio</span></Link></button>
...
<button class="Projects-Button">
  ...
  <Link activeClass='active' to='clients' spy={true} smooth={true} offset={-50} duration={500} className="desktopMenuListItem"><span class="text">Clients</span></Link>
  </button>
            ...
            <button className='desktopMenuBtn' onClick={()=>{
                ...
                <img src={Contact} alt='contact' className='desktopMenuBtnImg'/>Contact Me</button>
